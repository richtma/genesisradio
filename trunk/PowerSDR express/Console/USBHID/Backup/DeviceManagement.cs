	...
	internal class DeviceManagement
	{
      ...
      return false;
		...
		internal bool FindDeviceFromGuid (System.Guid myGuid, ref string[] devicePathName)
		{
            ...
            DeviceManagementApiDeclarations.SP_DEVICE_INTERFACE_DETAIL_DATA MyDeviceInterfaceDetailData = new PowerSDR.DeviceManagementApiDeclarations.SP_DEVICE_INTERFACE_DETAIL_DATA();
            DeviceManagementApiDeclarations.SP_DEVICE_INTERFACE_DATA MyDeviceInterfaceData = new PowerSDR.DeviceManagementApiDeclarations.SP_DEVICE_INTERFACE_DATA();
			int Result = 0;
