...
namespace PowerSDR
{
	class DB
	{
        ...
        {
            ds_band.Tables.Add("G59BandFilters");
            DataTable t = ds_band.Tables["G59BandFilters"];
        ...
        private static void AddG11BandFiltersTable()   // yt7pwr
        {
            ds_band.Tables.Add("G11BandFilters");
            DataTable t = ds_band.Tables["G11BandFilters"];
            ...
            object[] data = {
                                0.1, 0.300000, Band.B2190M.ToString(),
                                0.4, 0.600000, Band.B600M.ToString(),
                                1.0, 2.5, Band.B160M.ToString(),
                                2.500001, 4.5, Band.B80M.ToString(),
                                4.500001, 5.28, Band.B40M.ToString(),
                                5.280001, 5.405, Band.B60M.ToString(),
                                5.405001, 7.999999, Band.B40M.ToString(),
                                8.0, 12.5, Band.B30M.ToString(),
                                12.500001, 19.5, Band.B20M.ToString(),
                                19.500001, 34.0, Band.B15M.ToString(),
                                34.000001, 57.0, Band.B6M.ToString(),
                                144.0, 148.0, Band.B2M.ToString(),
                             };
