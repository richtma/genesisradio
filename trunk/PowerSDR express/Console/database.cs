...
namespace PowerSDR
{
	class DB
	{
        ...
        private static OleDbDataAdapter calibrateAdapter;
        private static OleDbDataAdapter rxCalibrateAdapter;
        private static OleDbDataAdapter txCalibrateAdapter;
        ...
        private static OleDbCommandBuilder calibrateCB;
        private static OleDbCommandBuilder rxCalibrateCB;
        private static OleDbCommandBuilder txCalibrateCB;
        ...
        public static DataSet dsCalibrate;
        public static DataSet dsRXCalibrate;
        public static DataSet dsTXCalibrate;
...
// ======================================================
		...
		private static void Create() // changes yt7pwr
		{
            ...
            AddCalibrateTable(ref cat);
            AddRXPhaseGainTable(ref cat);
            AddTXPhaseGainTable(ref cat);
			AddCWTable(ref cat);
			AddCWXTable(ref cat);
        ...
        private static void FillTables() // changes yt7pwr
		{
            ...
            AddRXPhaseGainPK(ref connection);
            AddTXPhaseGainPK(ref connection);
            ...
            FillRXPhaseGain(ref connection);
            FillTXPhaseGain(ref connection);

            FillMemory(ref connection);
        ...
        private static void AddCalibrateTable(ref Catalog c) // yt7pwr
        {
            Table calibrateTable = new Table();
            calibrateTable.Name = "Calibrate";
            calibrateTable.Columns.Append("ID", DataTypeEnum.adVarWChar, 50);
            calibrateTable.Columns.Append("SaveValue", DataTypeEnum.adVarWChar, 120);
            calibrateTable.Keys.Append("PrimaryKey", KeyTypeEnum.adKeyPrimary, "ID", null, null);
            c.Tables.Append(calibrateTable);
        }

        private static void AddRXPhaseGainTable(ref Catalog c) // yt7pwr
        {
            Table RXPhaseGainTable = new Table();
            RXPhaseGainTable.Name = "RXPhaseGain";
            RXPhaseGainTable.Columns.Append("BandName", DataTypeEnum.adVarWChar, 50);
            RXPhaseGainTable.Columns.Append("Frequency", DataTypeEnum.adDouble, 6);
            RXPhaseGainTable.Columns.Append("RXPhaseValue", DataTypeEnum.adDouble, 6);
            RXPhaseGainTable.Columns.Append("RXGainValue", DataTypeEnum.adDouble, 6);
            RXPhaseGainTable.Indexes.Append("PrimaryIndex", "BandName");
            c.Tables.Append(RXPhaseGainTable);
        }

        private static void AddTXPhaseGainTable(ref Catalog c) // yt7pwr
        {
            Table TXPhaseGainTable = new Table();
            TXPhaseGainTable.Name = "TXPhaseGain";
            TXPhaseGainTable.Columns.Append("BandName", DataTypeEnum.adVarWChar, 50);
            TXPhaseGainTable.Columns.Append("Frequency", DataTypeEnum.adDouble, 6);
            TXPhaseGainTable.Columns.Append("TXPhaseValue", DataTypeEnum.adDouble, 6);
            TXPhaseGainTable.Columns.Append("TXGainValue", DataTypeEnum.adDouble, 6);
            TXPhaseGainTable.Indexes.Append("PrimaryIndex", "BandName");
            c.Tables.Append(TXPhaseGainTable);
        }
        ...
        private static void AddBandStackTable(ref Catalog c) // changes yt7pwr
		{
			...
			bandStackTable.Columns.Append("VFOA", DataTypeEnum.adDouble, 6);
            bandStackTable.Columns.Append("VFOB", DataTypeEnum.adDouble, 6);
            bandStackTable.Columns.Append("LOSC", DataTypeEnum.adDouble, 6);
		...
		private static void AddBandStackPK(ref OleDbConnection connection)
		{
			...
			string pkcmd = "alter table BandStack add constraint pk_BandStack primary key (BandName, VFOA )";

			OleDbCommand cmd = new OleDbCommand(pkcmd, connection);
			cmd.ExecuteNonQuery();
		}

        private static void AddRXPhaseGainPK(ref OleDbConnection connection)  // yt7pwr
        {
            // set multiple field Primary Key for Band Memory
            string pkcmd = "alter table RXPhaseGain add constraint pk_RXPhaseGain primary key (BandName, Frequency )";

            OleDbCommand cmd = new OleDbCommand(pkcmd, connection);
            cmd.ExecuteNonQuery();
        }

        private static void AddTXPhaseGainPK(ref OleDbConnection connection) // yt7pwr
        {
            // set multiple field Primary Key for Band Memory
            string pkcmd = "alter table TXPhaseGain add constraint pk_TXPhaseGain primary key (BandName, Frequency )";

            OleDbCommand cmd = new OleDbCommand(pkcmd, connection);
            cmd.ExecuteNonQuery();
        }

        private static void AddMemoryTable(ref Catalog c)  // changes yt7pwr
		{
			Table memoryTable = new Table();
			memoryTable.Name = "Memory";
            memoryTable.Columns.Append("MemNumber", DataTypeEnum.adInteger, 6);
			memoryTable.Columns.Append("Frequency", DataTypeEnum.adDouble, 6);
            memoryTable.Columns.Append("LOSC", DataTypeEnum.adDouble, 6);
			memoryTable.Columns.Append("ModeID", DataTypeEnum.adInteger, 6);
			memoryTable.Columns.Append("FilterID", DataTypeEnum.adInteger, 6);
            memoryTable.Columns.Append("Step", DataTypeEnum.adInteger, 6);
            memoryTable.Columns.Append("AGC", DataTypeEnum.adInteger, 6);
            memoryTable.Columns.Append("Squelch", DataTypeEnum.adInteger, 6);
            memoryTable.Columns.Append("Zoom", DataTypeEnum.adInteger, 6);
            memoryTable.Columns.Append("Pan", DataTypeEnum.adInteger, 6);
            memoryTable.Columns.Append("Cleared", DataTypeEnum.adBoolean, 6);
			memoryTable.Keys.Append("PrimaryKey", KeyTypeEnum.adKeyPrimary, "MemNumber", null, null);
		...
		{
			// set multiple field Primary Key for Band Memory
			string pkcmd = "alter table Memory add constraint pk_Memory primary key (Frequency, LOSC)";
        ...
        private static void FillMemory(ref OleDbConnection conn)  // yt7pwr
        {
            OleDbDataAdapter myDataAdapter = new OleDbDataAdapter();
            myDataAdapter.SelectCommand = new OleDbCommand("SELECT * FROM Memory", conn);
            OleDbCommandBuilder cb = new OleDbCommandBuilder(myDataAdapter);
            DataSet ds = new DataSet();
            myDataAdapter.Fill(ds, "Memory");
            ...
            // save the updates
            myDataAdapter.Update(ds, "Memory");
        }

        private static void FillRXPhaseGain(ref OleDbConnection conn)  // yt7pwr
        {
            OleDbDataAdapter myDataAdapter = new OleDbDataAdapter();
            myDataAdapter.SelectCommand = new OleDbCommand("SELECT * FROM RXPhaseGain", conn);
            OleDbCommandBuilder cb = new OleDbCommandBuilder(myDataAdapter);
            DataSet ds = new DataSet();
            myDataAdapter.Fill(ds, "RXPhaseGain");

            object[] data = { "B160M", "B80M", "B60M", "B40M", "B30M",
                "B20M", "B17M", "B15M", "B12M", "B10M", "B6M", "GEN", "WWV"};
            double value = 0.0;
            int i, j = 0;
            ...
            for (i = 0; i < data.Length; i++)
            {
                for (j = -48; j < 48; j++)
                {
                    DataRow newRow = ds.Tables["RXPhaseGain"].NewRow();
                    newRow["BandName"] = (string)data[i];
                    newRow["Frequency"] = (double)j;
                    newRow["RXPhaseValue"] = (double)value;
                    newRow["RXGainValue"] = (double)value;
                    ds.Tables["RXPhaseGain"].Rows.Add(newRow);
                }
            }

            // save the updates
            myDataAdapter.Update(ds, "RXPhaseGain");
        }

        private static void FillTXPhaseGain(ref OleDbConnection conn)  // yt7pwr
        {
            OleDbDataAdapter myDataAdapter = new OleDbDataAdapter();
            myDataAdapter.SelectCommand = new OleDbCommand("SELECT * FROM TXPhaseGain", conn);
            OleDbCommandBuilder cb = new OleDbCommandBuilder(myDataAdapter);
            DataSet ds = new DataSet();
            myDataAdapter.Fill(ds, "TXPhaseGain");
            ...
            for (i = 0; i < data.Length; i++)
            {
                for (j = -48; j < 48; j++)
                {
                    DataRow newRow = ds.Tables["TXPhaseGain"].NewRow();
                    newRow["BandName"] = (string)data[i];
                    newRow["Frequency"] = (double)j;
                    newRow["TXPhaseValue"] = (double)value;
                    newRow["TXGainValue"] = (double)value;
                    ds.Tables["TXPhaseGain"].Rows.Add(newRow);
                }
            }

            // save the updates
            myDataAdapter.Update(ds, "TXPhaseGain");
        }
		...
		private static void FillBandStack(ref OleDbConnection conn)
		{
			...
			for(int i=0; i<data.Length/4; i++)
			{
                ...
                dr[4] = ((double)data[i * 4 + 3]).ToString("f6");
                dr[5] = ((double)data[i * 4 + 3]).ToString("f6");
...
//				"Data source=PowerSDR.mdb";
            ...
            if (a.BinarySearch("Calibrate") < 0)
                AddCalibrateTable(ref cat);

            if (a.BinarySearch("RXPhaseGain") < 0)
            {
                AddRXPhaseGainTable(ref cat);
                // Connect to the database
                OleDbConnection connection = new OleDbConnection();
            ...
            if (a.BinarySearch("TXPhaseGain") < 0)
                AddTXPhaseGainTable(ref cat);
...
// ======================================================
        ...
        public static void Init()  // changes yt7pwr
		{
            ...
            calibrateAdapter = new OleDbDataAdapter();
            calibrateAdapter.SelectCommand = new OleDbCommand("SELECT * FROM Calibrate", conn);
            calibrateCB = new OleDbCommandBuilder(calibrateAdapter);
            dsCalibrate = new DataSet();
            calibrateAdapter.Fill(dsCalibrate, "Calibrate");

            rxCalibrateAdapter = new OleDbDataAdapter();
            rxCalibrateAdapter.SelectCommand = new OleDbCommand("SELECT * FROM RXPhaseGain", conn);
            rxCalibrateCB = new OleDbCommandBuilder(rxCalibrateAdapter);
            dsRXCalibrate = new DataSet();
            rxCalibrateAdapter.Fill(dsRXCalibrate, "RXPhaseGain");

            txCalibrateAdapter = new OleDbDataAdapter();
            txCalibrateAdapter.SelectCommand = new OleDbCommand("SELECT * FROM TXPhaseGain", conn);
            txCalibrateCB = new OleDbCommandBuilder(txCalibrateAdapter);
            dsTXCalibrate = new DataSet();
            txCalibrateAdapter.Fill(dsTXCalibrate, "TXPhaseGain");
        ...
        public static void Update()  // changes yt7pwr
		{
			optionsAdapter.Update(dsOptions, "Options");
            calibrateAdapter.Update(dsCalibrate, "Calibrate");
            rxCalibrateAdapter.Update(dsRXCalibrate, "RXPhaseGain");
            txCalibrateAdapter.Update(dsTXCalibrate, "TXPhaseGain");
        ...
        // changes yt7pwr
		public static bool GetBandStack(string band, int index, out string mode, out string filter, out double freqA, out double freqB, out double losc_freq)
		{
        ...
        // changes yt7pwr
		public static void AddBandStack(string band, string mode, string filter, double freqA, double freqB, double losc_freq)
		{
        ...
        // changes yt7pwr
        public static void SaveBandStack(string band, int index, string mode, string filter, double VFOA, double VFOB, double losc_freq)
        {
            try
            {
                DataRow[] rows = dsBandStack.Tables["BandStack"].Select("'" + band + "' = BandName");
        ...
        public static void SaveRXAllCalibrate(double phase_value, double gain_value) // yt7pwr
        {
            try
            {
                DataRow[] rows = dsRXCalibrate.Tables["RXPhaseGain"].Select();

                foreach (DataRow datarow in rows)
                {
                    datarow["RXPhaseValue"] = phase_value;
                    datarow["RXGainValue"] = gain_value;
                }
        ...
        public static void SaveRXBandCalibrate(string band, double freq, double phase_value, double gain_value) // yt7pwr
        {
            try
            {
                DataRow[] rows = dsRXCalibrate.Tables["RXPhaseGain"].Select("'" + band + "' = BandName");
        ...
        public static void SaveRXCalibrate(string band, double freq, double phase_value, double gain_value) // yt7pwr
        {
            try
            {
                DataRow[] rows = dsRXCalibrate.Tables["RXPhaseGain"].Select("'" + band + "' = BandName");
                ...
                foreach (DataRow datarow in rows)
                {
                    if ((string)datarow["BandName"] == band && (double)datarow["Frequency"] == freq)
                    {
                        datarow["RXPhaseValue"] = phase_value;
                        datarow["RXGainValue"] = gain_value;
                        goto end;
                ...
                DataRow newRow = dsRXCalibrate.Tables["RXPhaseGain"].NewRow();
                newRow["BandName"] = band;
                newRow["Frequency"] = freq;
                newRow["RXPhaseValue"] = phase_value;
                newRow["RXGainValue"] = gain_value;
                dsRXCalibrate.Tables["RXPhaseGain"].Rows.Add(newRow);
        ...
        public static void ClearRXBandCallibrate(string band) // yt7pwr
        {
            try
            {
                DataRow[] rows = dsRXCalibrate.Tables["RXPhaseGain"].Select("'" + band + "' = BandName");
                ...
                foreach (DataRow datarow in rows)
                {
                    if ((string)datarow["BandName"] == band)
                    {
                        datarow["RXPhaseValue"] = 0.0;
                        datarow["RXGainValue"] = 0.0;
                    }
                }
        ...
        public static void ClearRXAllCallibrate() // yt7pwr
        {
            try
            {
                object[] band = { "B160M", "B80M", "B60M", "B40M", "B30M",
                    "B20M", "B17M", "B15M", "B12M", "B10M", "B6M", "GEN", "WWV"};
                DataRow[] rows;
                int i = 0;
                ...
                {
                    rows = dsRXCalibrate.Tables["RXPhaseGain"].Select("'" + band[i] + "' = BandName");
        ...
        public static void ClearTXBandCallibrate(string band) // yt7pwr
        {
            try
            {
                DataRow[] rows = dsTXCalibrate.Tables["TXPhaseGain"].Select("'" + band + "' = BandName");

                foreach (DataRow datarow in rows)
                {
                    if ((string)datarow["BandName"] == band)
                    {
                        datarow["TXPhaseValue"] = 0.0;
                        datarow["TXGainValue"] = 0.0;
                    }
                }
        ...
        public static void ClearTXAllCallibrate() // yt7pwr
        {
            try
            {
                object[] band = { "B160M", "B80M", "B60M", "B40M", "B30M",
                ...
                for (i = 0; i < band.Length; i++)
                {
                    ...
                    rows = dsTXCalibrate.Tables["TXPhaseGain"].Select("'" + band[i] + "' = BandName");
        ...
        public static void SaveTXAllCalibrate(double phase_value, double gain_value) // yt7pwr
        {
            try
            {
                DataRow[] rows = dsTXCalibrate.Tables["TXPhaseGain"].Select();

                foreach (DataRow datarow in rows)
                {
                    datarow["TXPhaseValue"] = phase_value;
                    datarow["TXGainValue"] = gain_value;
                }
        ...
        public static void SaveTXBandCalibrate(string band, double freq, double phase_value, double gain_value) // yt7pwr
        {
            try
            {
                DataRow[] rows = dsTXCalibrate.Tables["TXPhaseGain"].Select("'" + band + "' = BandName");
        ...
        public static void SaveTXCalibrate(string band, double freq, double phase_value, double gain_value) // yt7pwr
        {
            try
            {
                DataRow[] rows = dsTXCalibrate.Tables["TXPhaseGain"].Select("'" + band + "' = BandName");
                ...
                DataRow newRow = dsTXCalibrate.Tables["TXPhaseGain"].NewRow();
                newRow["BandName"] = band;
                newRow["Frequency"] = freq;
                newRow["TXPhaseValue"] = phase_value;
                newRow["TXGainValue"] = gain_value;
                dsTXCalibrate.Tables["TXPhaseGain"].Rows.Add(newRow);
        ...
        {
            DataRow[] rows = dsMemory.Tables["Memory"].Select();
        ...
        public static bool ClearMemory(int mem_number) // yt7pwr
        {
            try
            {
                DataRow[] rows = dsMemory.Tables["Memory"].Select("'" + mem_number + "' = MemNumber");
                foreach (DataRow datarow in rows)
                {
                    datarow["Cleared"] = true;
                }
        ...
        public static bool SaveMemory(int mem_number, double freq, double losc, int mode, int filter, 
            int step, int agc, int squelch, int zoom, int pan)
        {
            try
            {
                DataRow[] rows = dsMemory.Tables["Memory"].Select("'" + mem_number + "' = MemNumber");
        ...
        public static ArrayList GetRX_Phase_Gain() // yt7pwr
        {
            ArrayList list = new ArrayList();

            foreach (DataRow dr in dsRXCalibrate.Tables["RXPhaseGain"].Rows)
            {
        ...
        public static ArrayList GetTX_Phase_Gain() // yt7pwr
        {
            ...
            foreach (DataRow dr in dsTXCalibrate.Tables["TXPhaseGain"].Rows)
            {
                list.Add(dr[0].ToString() + "/" + dr[1].ToString() +
                    "/" + dr[2].ToString() + "/" + dr[3].ToString());
            }
        ...
        public static ArrayList GetCalibrate() // yt7pwr
        {
            ArrayList list = new ArrayList();

            foreach (DataRow dr in dsCalibrate.Tables["Calibrate"].Rows)
            {
                list.Add(dr[0].ToString()+"/"+dr[1].ToString()+"/"+dr[2].ToString());
            }
