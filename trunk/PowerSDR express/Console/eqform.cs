...
namespace PowerSDR
{
	...
	public class EQForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.MaximumSize = new System.Drawing.Size(600, 276);
            this.MinimizeBox = false;
            this.MinimumSize = new System.Drawing.Size(600, 276);
            this.Name = "EQForm";
...
/*                switch (value)
		...
		{
			int[] rxeq = RXEQ;
            DttSP.SetGrphRXEQ(0, 0, rxeq);
            DttSP.SetGrphRXEQ(0, 1, rxeq);
			picRXEQ.Invalidate();
		}
