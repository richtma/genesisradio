...
namespace PowerSDR
{
	unsafe class DttSP
	{
		...
		private static int SetMode(Mode m) // changes yt7pwr
		{
			SetMode_DLL(m);
            SetRXListen(2);
            int i = SetMode_DLL(m);
        ...
        private static int SetFilter(double low, double high, int taps, TransmitState trx_on) // changes yt7pwr
		{
...
//			RXOsc = freq;
        ...
        public static void SetNR(byte setit) // changes yt7pwr
		{
			SetNR_DLL(setit);
            SetRXListen(2);
            SetNR_DLL(setit);
        ...
        public static void SetNRvals(int taps, int delay, double gain, double leak) // changes yt7pwr
		{
        ...
        public static void SetANF(byte setit) // changes yt7pwr
		{
            SetANF_DLL(setit);
            SetRXListen(2);
			SetANF_DLL(setit);
        ...
        public static void SetANFvals(int taps, int delay, double gain, double leak) // changes yt7pwr
		{
        ...
        public static void SetRXAGC(AGCMode setit) // changes yt7pwr
		{
            SetRXAGC_DLL(setit);
            SetRXListen(2);
			SetRXAGC_DLL(setit);
        ...
        public static void SetGrphRXEQ(int[] rxeq) // changes yt7pwr
		{
        ...
        public static void SetGrphRXEQcmd(byte state) // changes yt7pwr
		{
        ...
        public static void SetNB(byte setit) // changes yt7pwr
		{
            SetNB_DLL(setit);
            SetRXListen(2);
			SetNB_DLL(setit);
        ...
        public static void SetNBvals(double threshold) // changes yt7pwr
		{
        ...
        public static void SetSDROM(byte setit) // changes yt7pwr
		{
            SetSDROM_DLL(setit);
            SetRXListen(2);
			SetSDROM_DLL(setit);
        ...
        public static void SetSDROMvals(double threshold) // changes yt7pwr
		{
        ...
        public static void SetFixedAGC(double fixed_agc) // changes yt7pwr
		{
        ...
        public static void SetRXAGCMaxGain(double max_agc) // changes yt7pwr
		{
        ...
        public static void SetRXAGCAttack(int attack) // changes yt7pwr
		{
        ...
        public static void SetRXAGCDecay(int attack) // changes yt7pwr
		{
        ...
        public static void SetRXAGCHang(int hang) // changes yt7pwr
		{
		...
		public static extern void SetRXOutputGain_DLL(double g);
        public static void SetRXOutputGain(int index, double gain) // changes yt7pwr
		{
			switch(index)
			{
				case 0:
					SetRXOutputGain_DLL(gain);
					break;
				case 1:
					SetRXListen(1);
					SetRXOutputGain_DLL(gain);
        ...
        public static void SetRXAGCSlope(int slope) // changes yt7pwr
		{
        ...
        public static void SetRXAGCHangThreshold(int hangthreshold) // changes yt7pwr
		{
        ...
        public static void SetBIN(byte setit) // changes yt7pwr
		{
            SetBIN_DLL(setit);
            SetRXListen(2);
			SetBIN_DLL(setit);
        ...
        public static void SetBlkNR(byte setit) // changes yt7pwr
		{
            SetBlkNR_DLL(setit);
            SetRXListen(2);
			SetBlkNR_DLL(setit);
        ...
        public static void SetBlkANF(byte setit) // changes yt7pwr
		{
            SetBlkANF_DLL(setit);
            SetRXListen(2);
			SetBlkANF_DLL(setit);
        ...
        public static void SetSquelchVal(float setit) // changes yt7pwr
		{
        ...
        public static void SetSquelchState(byte state) // changes yt7pwr
		{
