...
namespace PowerSDR
{
	public class WaveControl : System.Windows.Forms.Form
	{
		...
		public System.Windows.Forms.CheckBoxTS checkBoxPlay;
		...
		private void InitializeComponent()
		{
            ...
            this.MaximumSize = new System.Drawing.Size(424, 357);
            this.Menu = this.mainMenu1;
            this.MinimizeBox = false;
            this.MinimumSize = new System.Drawing.Size(424, 357);
        ...
        private void checkBoxPlay_CheckedChanged(object sender, System.EventArgs e)
        {
            if (checkBoxPlay.Checked)
            {
                ...
                {
                    console.chkPlayWav.Checked = false;
                    MessageBox.Show("There is no open Wav files!");
                }
            }
            else
            {
                if (console.chkPlayWav.Checked)
                    console.chkPlayWav.Checked = false;
                else
                    console.WBIR_state = WBIR_State.DelayAdapt;             // restart WBIR
